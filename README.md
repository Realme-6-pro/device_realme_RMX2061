...
```bash
# Device Tree
git clone https://github.com/Realme-6-pro/device_realme_RMX2061.git device/realme/RMX2061 -b corvus
...
source build/env*.sh && lunch corvus_RMX2061-userdebug && mka bacon
```
